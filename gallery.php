        ...
        <header class = "flex header-sm">
            <div class = "container">
                <div class = "header-title">
                    <h1>Capture Memories with TripTreasure!</h1>
            ...
            <div class = "popular-row">
                <div class = "popular-item shadow">
                    ...
                    <div>
                        ...
                        <p class = "text">The Eiffel Tower, an iconic symbol of <br> Paris, stands at 324 meters tall and <br> offers stunning panoramic views.</p>
                    </div>
                </div>
                ...
                <div class = "popular-item shadow">
                    ...
                    <div>
                        ...
                        <p class = "text">Machu Picchu is a stunning Incan <br> citadel set high in the Andes, <br> renowned for its archaeological.</p>
                    </div>
                </div>
                ...
                <div class = "popular-item shadow">
                    ...
                    <div>
                        ...
                        <p class = "text">The Acropolis in Athens is a historic site <br> with ancient ruins, including the <br> Parthenon.</p>
                    </div>
                </div>
                ...
                <div class = "popular-item shadow">
                    ...
                    <div>
                        ...
                        <p class = "text">Bali, Indonesia is renowned for its <br> stunning beaches, vibrant culture.</p>
                    </div>
                </div>
                ...
                <div class = "popular-item shadow">
                    ...
                    <div>
                        ...
                        <p class = "text">Dubai, UAE is famous for its futuristic skyline, luxury shopping, and the iconic <br> Burj Khalifa.</p>
                    </div>
                </div>
                ...
                <div class = "popular-item shadow">
                    ...
                    <div>
                        ...
                        <p class = "text">Bhutan is renowned for its stunning Himalayan landscapes.</p>
                    </div>
                </div>
                ...
                <div class = "popular-item shadow">
                    ...
                    <div>
                        ...
                        <p class = "text">Havana, Cuba, is famed for its vibrant colonial architecture and rich cultural history.</p>
                    </div>
                </div>
                ...
                <div class = "popular-item shadow">
                    ...
                    <div>
                        ...
                        <p class = "text">Moscow, Russia, is known for its <br> stunning Red Square and historic <br> Kremlin. </p>
                    </div>
                </div>
            </div>
        </section>
